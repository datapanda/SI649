<?php 
	...
	$query = mysql_query("SELECT username, COUNT(*) as friday FROM conversations WHERE year = 2009 AND month = ". $month . " AND weekday = 6 AND username != 'Me' AND username != 'aolsystemmsg' GROUP BY username") or die(mysql_errno($connection));
