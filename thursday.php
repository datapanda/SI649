<?php 
	...
	$query = mysql_query("SELECT username, COUNT(*) as thursday FROM conversations WHERE year = 2009 AND month = ". $month . " AND weekday = 3 AND username != 'Me' AND username != 'aolsystemmsg' GROUP BY username") or die(mysql_errno($connection));
