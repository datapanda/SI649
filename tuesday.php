<?php 
	...
	$query = mysql_query("SELECT username, COUNT(*) as day FROM conversations WHERE year = ". $year . " AND month = ". $month . " AND weekday = 1 AND username != 'Me' AND username != 'aolsystemmsg' GROUP BY username") or die(mysql_errno($connection));
